...
class LaneFinder
{
		  ...
		  public:
					 ...
					 void findLines(IplImage* img, IplImage* img_out, double* alpha, int &x_pos, std::vector< struct line_points*> &longestLine, int lowerLimit, int higherLimit, int yLimit, std::vector< std::vector< struct line_points* > > &bin, std::vector< std::vector< struct line_points* > > &binRight, int minSize, int lengthTangent );
